...
public class HomeOtherListAdapter extends RecyclerView.Adapter<HomeOtherListAdapter.HomeOtherListHolder> {
    ...
    public HomeOtherListAdapter(Context context, List<HomeListBean.GoodsInfoBean> list) {
    ...
    public void onBindViewHolder(@NonNull HomeOtherListHolder holder, int position) {
        ...
        holder.sale_num.setText("今日销量" + NumUtil.getNum(list.get(position).getSales()) + "单");
        if (onItemClick != null) {
