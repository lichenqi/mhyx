...
/*纯网络图片转文件分享*/
public class OnlyNet2FileShare {

    private Context context;
    private List<File> files = new ArrayList<>();
    private ComponentName comp;

    public OnlyNet2FileShare(Context context) {
        this.context = context;
    }

    public void setShareImage(List<CircleRecommendBean.InfoBean.ImgInfoBean> imagesList, String shareAppType) {
